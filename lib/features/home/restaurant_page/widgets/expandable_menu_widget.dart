...
import 'package:zomoto_task/features/home/restaurant_page/widgets/food_item_widget.dart';
import 'package:zomoto_task/features/home/restaurant_page/widgets/restaurant_menu_items_widget.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (expanded) const RestaurantMenuItemsWidget(),
        ],
      ),
    );
  }
