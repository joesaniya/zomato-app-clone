...
import 'package:zomoto_task/common/firebaseprovider/firebase_instance_provider.dart';
import 'package:zomoto_task/common/models/pair.dart';
import 'package:zomoto_task/common/models/user.dart';

final loginSignUpRepositoryProvider = Provider((ref) => LoginSignUpRepository(
    ref.watch(firebaseAuthProvider), ref.watch(facebookAuthProvider)));
...
class LoginSignUpRepository {
  ...
  void signInWithPhone(
      String phoneNumber, Function(String, int?) verification) async {
    try {
